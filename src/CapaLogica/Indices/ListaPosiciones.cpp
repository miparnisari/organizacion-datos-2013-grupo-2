...
ReferenciaListaPos_t ListaPosiciones::guardar (const ListaPos_t & lista)
{
...
ListaPos_t ListaPosiciones::devolver (const CantidadPosiciones_t cuantos, const ReferenciaListaPos_t desde)
{
